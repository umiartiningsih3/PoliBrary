...
@endif
    ...
    @if(auth()->check() && in_array(strtolower(auth()->user()->tipe_keanggotaan), ['mahasiswa','dosen']))
        ...
        {{-- Disukai Saya --}}
        <a href="{{ route('disukai') }}"
   class="flex items-center gap-4 px-4 py-3 text-sm font-medium rounded-lg transition {{ Route::is('disukai') ? 'bg-blue-50/70 text-[#0052cc] font-semibold' : 'text-gray-600 hover:bg-slate-50 hover:text-[#0052cc]' }}">
